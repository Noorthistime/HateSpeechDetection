...
menu = st.sidebar.radio("Go to", ["Project Overview", "1. Data Loading & Cleaning", "2. Model Training & Evaluation", "3. Live Prediction Test", "4. Full Code Explorer", "5. View Raw Source Code", "Credits & Contact"])
